	...
	case pluginabi.MethodManagementRegister:
		return okEnvelope(managementRegistration{
			...
			Routes: []managementRoute{
				...
				{Method: "GET", Path: "/v0/management/portal/available-models", Description: "可用模型列表"},
				{Method: "GET", Path: "/v0/management/portal/model-groups", Description: "模型分组列表"},
				{Method: "POST", Path: "/v0/management/portal/model-groups", Description: "保存模型分组"},
				{Method: "POST", Path: "/v0/management/portal/model-groups/create", Description: "创建模型分组"},
				{Method: "POST", Path: "/v0/management/portal/model-groups/update", Description: "更新模型分组"},
				{Method: "POST", Path: "/v0/management/portal/model-groups/delete", Description: "删除模型分组"},
